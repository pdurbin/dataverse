...
public class Datasets extends AbstractApiBean {
    ...
    public Response exportDataset(@Context ContainerRequestContext crc, @QueryParam("persistentId") String persistentId,
        ...
        try {
            ...
            if (exporter.equals("croissant") || exporter.equals("croissantSlim")) {
                JsonObjectBuilder reviews = getReviewsForCroissant(dataset, req);
                ...
                String updatedContent = Json.createObjectBuilder(croissantJson)
                        .add("reviews", Json.createArrayBuilder()
                                .add(reviews.build().getJsonArray("reviews")))
                        .build()
                        .toString();
    ...
    private JsonObjectBuilder getReviewsForCroissant(Dataset dataset, DataverseRequest req) throws CommandException {
        String title = "foo";
        return CroissantExportUtil.getReviews(commandEngine.submit(new GetDatasetReviewsCommand(req, dataset)), title);
    }
