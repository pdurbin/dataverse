...
public class InsideOutCroissantExporter implements Exporter {

    private static final Logger logger = Logger.getLogger(InsideOutCroissantExporter.class.getCanonicalName());

    public static final String NAME = "insideOutCroissant";
    ...
    public String getMediaType() {
        // This may change in the future. See https://github.com/gdcc/exporter-croissant/pull/7
