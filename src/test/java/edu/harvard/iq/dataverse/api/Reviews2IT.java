...
public class Reviews2IT {
    ...
    public static void setUpClass() {
        ...
        try {
            reviewDescription = JsonUtil.getJsonObjectFromFile("scripts/api/data/datasetTypes/review.json")
    ...
    /**
     * In this test, we check if temReviewedUrl and itemReviewedType are required.
     * (They are subfields of itemReviewed.) In review.tsv they are set to required.
     */
    @Test
