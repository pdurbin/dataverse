 ...
 */
@LocalJvmSettings
public class InsideOutCroissantTest {

    private static final Logger logger = Logger.getLogger(InsideOutCroissantTest.class.getCanonicalName());
    ...
    private static final InsideOutCroissantExporter insideOutCroissantExporter = new InsideOutCroissantExporter();
    ...
    private JsonObject createExportFromJson(ExportDataProvider provider) throws JsonParseException, ParseException {
        ...
        String datasetTypeString = DatasetType.DATASET_TYPE_DATASET;
        DatasetType datasetType = new DatasetType();
        datasetType.setName(datasetTypeString);
        ...
        if(insideOutCroissantExporter == null) logger.fine("sdoe" + " null");
        try {
            ExportDataProvider provider2 = new InternalExportDataProvider(version);
            insideOutCroissantExporter.exportDataset(provider2, byteArrayOutputStream);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void testGetProviderName() {
        assertEquals("insideOutCroissant", insideOutCroissantExporter.getFormatName());
    }
    ...
    public void testGetDisplayName() {
        ...
        assertEquals("Schema.org JSON-LD", insideOutCroissantExporter.getDisplayName(null));
    }
    ...
    public void testIsXMLFormat() {
        assertFalse(insideOutCroissantExporter instanceof XMLExporter);
    }
    ...
    public void testIsHarvestable() {
        assertFalse(insideOutCroissantExporter.isHarvestable());
    }
    ...
    public void testIsAvailableToUsers() {
        assertFalse(insideOutCroissantExporter.isAvailableToUsers());
    }
