...
public class JsonPrinterTest {
    ...
    public void testJson_RoleAssignment() {
        ...
        assertEquals(":privateUrlForDvObjectId42", jsonObject.getString("assignee"));
    ...
    public void testJson_PrivateUrl() {
        ...
        assertEquals(":privateUrlForDvObjectId42", jsonObject.getJsonObject("roleAssignment").getString("assignee"));
    }
