 ...
 * <p>
 * Fire different passwords and settings to the validator service and compare them to an expected
 * outcome.
 *
...
public class PasswordValidatorTest {
    ...
    /**
     * Helper class so we can pass on a list of passwords and validation settings to falsify the
     * outcome.
     */
    ...
    public void testDifferentPasswordsAndSettings() {
        ...
        paramsList.forEach(
                params -> {
                    ...
                    logger.info(message);
                    assertTrue(message, actualErrors == expectedErrors);
                }
        );
